...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "tag") {
    //BUNU YAZINCA ALTTAKİ MESAJ GİDİCEK
    msg.reply("∆ Buyur Tagımız"); //YUKARIDAKİNİ YAZINCA BU CEVABI VERİCEK
  }
});
client.on("message", msg => {
  if (msg.content.toLowerCase() === "sa") {
    //BUNU YAZINCA ALTTAKİ MESAJ GİDİCEK
    msg.reply("Aleyküm Selam, Hoş Geldin Dostum"); //YUKARIDAKİNİ YAZINCA BU CEVABI VERİCEK
  }
});
client.on("message", msg => {
  if (msg.content.toLowerCase() === "Sa") {
...
client.on("ready", async function() {
  const voiceChannel = "778007014684622909";
